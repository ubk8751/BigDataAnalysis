...
while True:
    try:
        ...
        # Append processing times to respective lists
        ...
        # Calculate and print statistics every 30 minutes (adjust as needed)
        if len(files_processing_times) > 0 and len(files_processing_times) % (1 * 60 / 10) == 0:
